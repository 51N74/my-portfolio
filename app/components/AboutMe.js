  ...
  return (
    ...
    <p className="mt-4 text-white">
        ...
        <p className="mt-4 text-white">
          ...
          business management, time scheduling, cost control, and even coffee
        ...
        <p className="mt-4 text-white">
          ...
          customizing websites based on client needs. My role involves CSS
          development, theme customization, and occasional plugin modifications
          using PHP.
        </p>
        ...
        <p className="mt-4 text-white">
          ...
          camera options, developing and scanning film, and ensuring an
          excellent customer experience. This role further honed my time
        ...
        <p className="mt-4 text-white">
          ...
          Developer. My current learning journey includes exploring frameworks
          like React and Next.js, as well as backend technologies like Node.js
          and Python. Passionate about web development, I embrace new challenges
          and strive to deliver impactful solutions.
        </p>
        </>
  );
}